import time
punkty = {
  "a":1 , "A":5,"b":3 , "c":2,"C":5 ,"d":2 , "e":1,"E":5,"f":5,"g":3,"h":3,"i":1,"j":3,"k":2,"l":2,"L":3,"m":2,"n":1,"N":7,"o":1,"O":5,"p":2,"r":1,"s":1,"S":5,"t":2,"u":3,"w":1,"y":2,"z":1,"Z":9,"X":5
  }
def score(w):
  sc=0
  for l in w:
...
def player2(pp1,pp2):
  ...
  while slw!= "stop!" or gr!="stop!":
    gr = raw_input("który gracz?")
    slw = raw_input("jakie slowo?")
...
def x22(p1,p2):
  ...
  print "aby wyswietlić wyniki w pytaniu o gracza lub pytaniu o slowo nalezy wpisac wyniki!. Aby zakończyc grę i wyświetlic wyniki nalezy w pytaniu(dowolnym) wpisac stop!"
  print
...
def pomoc() :
  ...
  ddd=raw_input(  "( aby wyswietlic caly dostepny alfabet i ilosc punktow  wpisz alf , a zeby pominac nacisnij enter)")
  if ddd == "alf":
    print punkty
  stt()
def stt():
